...
from ...core.common import RuntimeOptionsView, build_audio_file, read_model_identifier
...
def build_multipart_audio_transcription_request(
    ...
    *,
    ...
    overrides = options.parameter_overrides.get(policy_provider, "audio_transcription")
    ...
    form_data = {str(key): form_field_value(value) for key, value in envelope.body.items() if key != "file"}
    return (
        form_data,
