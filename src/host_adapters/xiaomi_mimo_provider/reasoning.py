...
class MimoReasoningManager:
    ...
    @staticmethod
    def _assistant_messages_by_call_id(body: dict[str, JsonValue]) -> dict[str, dict[str, JsonValue]]:
    ...
    @staticmethod
    def _provider_payload(extra_content: dict[str, JsonValue]) -> dict[str, JsonValue]:
