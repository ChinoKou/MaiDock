from ...clients.common import truncate_upstream_detail
...
def dashscope_error_factory(
    ...
    upstream_message = truncate_upstream_detail(raw_message) if isinstance(raw_message, str) and raw_message else None
...
def raise_for_dashscope_error(payload: dict[str, JsonValue]) -> None:
