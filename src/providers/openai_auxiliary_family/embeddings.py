...
class OpenAICompatibleEmbeddingMapper:
    ...
    def build_request(
        ...
        policy = self.options.parameter_policies.get(self.policy_provider, "embeddings")
        ...
        body: dict = {"model": model, "input": request.embedding_input}
    ...
    def extract_embedding(self, payload: dict, *, encoding_format: str = "float") -> list[float]:
